import { startCamera, flipCamera } from './camera.js?v=3'
import { takePhoto } from './photo.js?v=3'
import { toggleVideo } from './video.js?v=3'
import { sendFile } from './upload.js?v=3'
